...
- **Markdown formatting**: don't hard-wrap prose — write each paragraph/bullet as a single unwrapped line and let the renderer reflow it. Applies to markdown files (docs under `content/`, README), PR/issue descriptions, and PR/issue comments. Commit bodies are exempt.
